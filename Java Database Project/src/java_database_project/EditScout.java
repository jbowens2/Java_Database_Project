...
public class EditScout extends JFrame{
	...
	public void setData(){
		Troop_Combo.setSelectedItem(TabbedPanel.temp_scout_troop_id);
		firstname.setText(TabbedPanel.temp_scout_firstname);
		lastname.setText(TabbedPanel.temp_scout_lastname);
		phone.setText(TabbedPanel.temp_scout_phone);
		email.setText(TabbedPanel.temp_scout_email);
		birthdate.setText(TabbedPanel.temp_scout_birthdate);
		start_date.setText(TabbedPanel.temp_scout_startdate);
		parent.setText(TabbedPanel.temp_scout_parent);
		address.setText(TabbedPanel.temp_scout_address);
		city.setText(TabbedPanel.temp_scout_city);
		state_combo.setSelectedItem(TabbedPanel.temp_scout_state);//totally works
	...
	private class SwingAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			Main.makeConnection();
			try{
				Main.preparedStatement = Main.connection.prepareStatement("UPDATE SCOUT SET FIRSTNAME = ?, LASTNAME = ?, PHONE = ?, EMAIL = ?, BIRTHDATE = ?, START_DATE = ?, PARENT = ?, ADDRESS = ?, CITY = ?, STATE = ?, ZIPCODE = ?, TROOP_ID = ? WHERE SCOUT_ID = ?");
				...
				Main.preparedStatement.setInt(13, Integer.valueOf(TabbedPanel.temp_scout_id));
