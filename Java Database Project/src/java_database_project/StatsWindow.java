...
public class StatsWindow extends JFrame{
	...
	private JLabel total_inventory, total_shipment;
	...
	public StatsWindow(){
		...
		total_shipment = new JLabel("Total Inventory:");
	...
	public void loadData(){
		...
		try {
			...
			//
			Main.preparedStatement = Main.connection.prepareStatement("SELECT SUM(RECEIVED) FROM SHIPMENT");
			Main.result = Main.preparedStatement.executeQuery();
			while(Main.result.next()){
				total_shipment.setText(String.valueOf(Main.result.getLong(1)));
			}
