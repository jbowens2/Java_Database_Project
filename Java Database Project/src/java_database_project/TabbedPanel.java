...
public class TabbedPanel extends JTabbedPane{
	...
	public TabbedPanel (){	
		...
		new_troop_information.setBounds(10, 11, 336, 20);
		...
		lblTroopName.setBounds(10, 69, 84, 25);
		new_troop.add(lblTroopName);
		
		textField = new JTextField();
		textField.setBounds(104, 69, 624, 25);
		new_troop.add(textField);
		textField.setColumns(10);
		
		JLabel lblTroopCity = new JLabel("Troop City:");
		lblTroopCity.setHorizontalAlignment(SwingConstants.RIGHT);
		lblTroopCity.setBounds(20, 207, 77, 14);
		new_troop.add(lblTroopCity);
		
		textField_1 = new JTextField();
		textField_1.setBounds(104, 202, 242, 25);
		new_troop.add(textField_1);
		textField_1.setColumns(10);
		
		JLabel lblState = new JLabel("State:");
		lblState.setHorizontalAlignment(SwingConstants.RIGHT);
		lblState.setBounds(376, 207, 46, 14);
		new_troop.add(lblState);
		
		String[] states = { "MD","DC" };
		JComboBox comboBox = new JComboBox(states);
		comboBox.setBounds(432, 204, 92, 20);
		comboBox.setSelectedIndex(0);
		new_troop.add(comboBox);
		
		Label zipcode = new Label("Zipcode:");
		zipcode.setAlignment(Label.RIGHT);
		zipcode.setBounds(543, 207, 76, 22);
		new_troop.add(zipcode);
		
		textField_2 = new JTextField();
		textField_2.setBounds(625, 201, 103, 25);
		new_troop.add(textField_2);
		textField_2.setColumns(10);
		
		JLabel lblAddress = new JLabel("Address:");
		lblAddress.setHorizontalAlignment(SwingConstants.RIGHT);
		lblAddress.setBounds(36, 138, 58, 14);
		new_troop.add(lblAddress);
		
		textField_3 = new JTextField();
		textField_3.setBounds(104, 135, 624, 25);
		new_troop.add(textField_3);
